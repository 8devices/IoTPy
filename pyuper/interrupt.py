...
class Interrupt:
    ...
    def __init__(self, board, pin):
        ...
        if self.board.pinout[pin][0] & self.board.cap_gpio:
            ...
            errmsg("UPER error: Pin No:%d is not GPIO pin, can't attach interrupt.", pin)
            raise UPER_APIError("Wrong Pin number.")
    ...
    def attach(self, mode, callback):
        try:
            ...
            try:
                ...
                raise UPER_APIError("Too many interrupts.")
    ...
    def detach(self):
        try:
            ...
            UPER_APIError("trying to detaching non existing interrupt.")
